...
export function PositionSize({ shares, value, unitAmount, riskPerShare, rrRatio, canCalculate, isDarkMode }: PositionSizeProps) {
  ...
  return (
    <div className="space-y-3 sm:space-y-4 md:space-y-6 flex flex-col w-full">
      ...
      <Card className={`p-4 sm:p-6 md:p-8 border-0 shadow-lg overflow-hidden relative transition-all duration-300 flex-1 flex flex-col ${
        isDarkMode
        ...
        <div className="relative z-10 flex flex-col h-full">
          ...
          <div className="flex flex-col lg:flex-col flex-1">
            {/* Shares */}
            <div className="flex-1 flex flex-col justify-center mb-3 sm:mb-4 lg:mb-4 md:lg:mb-6">
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-baseline gap-2">
                    <span className={`text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight text-white transition-opacity ${
                      canCalculate ? 'opacity-100' : 'opacity-30'
                    }`}>
            ...
            {/* Divider */}
            <div className="w-full lg:w-full h-px lg:h-px border-t border-white/20 my-2 sm:my-3 lg:my-0 lg:pt-4 sm:lg:pt-5 md:lg:pt-6"></div>
            ...
            <div className="flex-1 flex flex-col justify-center">
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-baseline gap-2">
                    <span className={`text-2xl sm:text-2xl md:text-3xl font-semibold text-white transition-opacity ${
                      canCalculate ? 'opacity-100' : 'opacity-30'
                    }`}>
      ...
      <Card className={`p-4 sm:p-5 md:p-6 shadow-sm transition-all duration-300 ${
        isDarkMode 
          ? 'bg-gray-800 border-gray-700' 
          : 'bg-white border-gray-200'
      }`}>
        <h3 className={`text-[10px] sm:text-xs uppercase tracking-wider mb-3 sm:mb-4 transition-colors ${
        ...
        <div className="flex lg:flex-col gap-4 lg:space-y-0">
          ...
          <div className={`w-px lg:w-full lg:h-px transition-colors ${
