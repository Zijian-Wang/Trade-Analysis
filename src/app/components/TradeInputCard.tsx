...
export function TradeInputCard({
  ...
  return (
    <Card className={`p-4 sm:p-5 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col h-full ${
      isDarkMode 
      ...
      <div className="space-y-4 flex-1">
        ...
        <div className="grid grid-cols-2 gap-3 sm:gap-4 items-end">
          ...
          <div className="space-y-2">
            <Label className={`text-[10px] sm:text-xs uppercase tracking-wider transition-colors ${
              isDarkMode ? 'text-gray-400' : 'text-gray-500'
            }`}>Portfolio Capital</Label>
            <div className="relative">
              <span className={`absolute left-2.5 sm:left-3 top-1/2 -translate-y-1/2 text-base sm:text-lg font-medium transition-colors ${
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              />
              <span className={`absolute right-3 top-1/2 -translate-y-1/2 text-base sm:text-lg font-medium transition-colors ${
            ...
            <Slider
              ...
              className="w-full"
            />
            <div className={`flex justify-between text-[10px] -mt-1 transition-colors ${
        ...
        <div className="grid grid-cols-2 gap-3 sm:gap-4">
          ...
          <div className="space-y-2">
            ...
            <div className={`flex rounded-full p-0.5 sm:p-1 transition-colors ${
        ...
        <div className="grid grid-cols-3 gap-3 sm:gap-4">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <span className={`absolute left-2 sm:left-2.5 top-1/2 -translate-y-1/2 text-sm sm:text-base font-semibold transition-colors ${
                isDarkMode ? 'text-gray-600' : 'text-gray-400'
              }`}>$</span>
              <Input
                type="number"
      ...
      <div className="mt-auto pt-4 hidden lg:block">
        <button 
          ...
          className={`w-full py-3 sm:py-3.5 px-4 rounded-xl font-medium transition-all shadow-md flex items-center justify-center gap-2 group text-sm sm:text-base ${
            canCalculate
              ? isDarkMode
        ...
        >
          ...
          <ArrowUpRight className={`w-4 h-4 transition-transform ${
            canCalculate ? 'group-hover:translate-x-0.5 group-hover:-translate-y-0.5' : ''
          }`} />
        </button>
      </div>
    </Card>
